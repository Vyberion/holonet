export default {
  ...
  nicknames: {
    ...
    managed: {
      ...
      DIVISIONS: {
        reavers: {
          ranks: {
            "200": { mode: "prefix", value: "Reaver Commandant" },
        ...
        dhg: {
          ranks: {
            "100": { mode: "prefix", value: "Guard Commandant" },
  ...
  roles: {
    ...
    managed: {
      DARK_COUNCIL: {
        ranks: {
          "255": "1046451358515089449",
          "254": "1302790774458552331",
          "253": "1046451363384668320",
          "250": "1109325343824826399",
          "100": "1109325343824826399",
          "25": "1109325343824826399",
          "20": "1109325343824826399",
          "15": "1109325343824826399",
      ...
      DIVISIONS: {
        reavers: {
          ...
          ranges: [
            { min: 1, max: 200,roles: ["1046451382351314984"] },
        ...
        dhg: { 
          ranks: { 
            "100": ["", "", "1134204341855727766", "1134204341855727766", "1134204341855727766"], 
          },
          ranges: [
            { min: 1, max: 90, roles: ["1134204341855727766"]},
            { min: 60, max: 90, roles: ["1134204341855727766"]},
            { min: 80, max: 90, roles: ["1134204341855727766"]},
          ]
        },
        inquisitors: { 
          ranks: { 
          ...
          ranges: [
            ...
            { min: 1, max: 200, roles: ["1046451376236003359"]},
          ]
          },
        dreadmasters: { 
          ranks: { 
          ...
          ranges: [
            { min: 1, max: 36, roles: ["1455305201451008192"]},
