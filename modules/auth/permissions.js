const PAGE_ACCESS = {
  ...
  council: { require: 'pages:view:darkcouncil' },
  council_home: { require: 'pages:view:darkcouncil' },
  council_info: { require: 'pages:view:darkcouncil' },
  council_floor: { require: 'pages:view:darkcouncil' },
  council_docket: { require: 'pages:view:darkcouncil' },
  council_decrees: { require: 'pages:view:darkcouncil' },
  council_handbooks: { require: 'pages:view:darkcouncil' },
  council_transmissions: { require: 'pages:view:darkcouncil' },
  council_reports: { require: 'pages:view:darkcouncil' },
  council_activity: { require: 'pages:view:darkcouncil' },
  dark_council: { require: 'pages:view:darkcouncil' },
  dark_council_home: { require: 'pages:view:darkcouncil' },
  dark_council_info: { require: 'pages:view:darkcouncil' },
  dark_council_floor: { require: 'pages:view:darkcouncil' },
  dark_council_council_floor: { require: 'pages:view:darkcouncil' },
  dark_council_docket: { require: 'pages:view:darkcouncil' },
  dark_council_decrees: { require: 'pages:view:darkcouncil' },
  ...
  darkcouncil_info: { require: 'pages:view:darkcouncil' },
  darkcouncil_floor: { require: 'pages:view:darkcouncil' },
  darkcouncil_council_floor: { require: 'pages:view:darkcouncil' },
  darkcouncil_docket: { require: 'pages:view:darkcouncil' },
  darkcouncil_decrees: { require: 'pages:view:darkcouncil' },
