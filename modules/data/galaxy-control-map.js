...
const galaxyPlanetTextures = folder => {
  ...
  return Object.fromEntries(Object.entries(TEXTURE_FILE_NAMES).flatMap(([key, fileName]) => [
    [key, `${base}/${fileName}`],
    [`${key}Preview`, `${base}/${previewFileName(fileName)}`]
  ]));
};
...
export const GALAXY_CONTROL_MAP = {
  ...
  sectors: [
    ...
    { id: "kathol", name: "Raioballo Sector", regionId: "outer-rim", grid: "L-4", factionId: "jedi-republic", placementConfidence: "Legends placement: Dantooine system in the Raioballo sector of the Outer Rim.", innerRadius: 5.18, outerRadius: 6.7, innerStartRadius: 5.0, outerEndRadius: 6.52, startAngleDeg: 202, endAngleDeg: 232 },
