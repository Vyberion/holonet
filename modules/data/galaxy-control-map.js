export const GALAXY_CONTROL_MAP = {
  ...
  sectors: [
    { id: "tython-deep-core", name: "Tython Deep Core", regionId: "deep-core", grid: "K-10", factionId: "jedi-republic", placementConfidence: "Approximate Legends/Old Republic placement", innerRadius: 0.16, outerRadius: 0.86, outerStartRadius: 0.72, outerEndRadius: 0.96, startAngleDeg: -150, endAngleDeg: -96 },
    { id: "coruscant", name: "Coruscant Sector", regionId: "core", grid: "L-9", factionId: "jedi-republic", placementConfidence: "Core Worlds / Republic capital broad placement", innerRadius: 0.42, outerRadius: 1.28, outerStartRadius: 1.16, outerEndRadius: 1.36, startAngleDeg: -96, endAngleDeg: -36 },
    { id: "corellian", name: "Corellian Sector", regionId: "core", grid: "M-10", factionId: "jedi-republic", placementConfidence: "Core Worlds broad placement", innerRadius: 0.78, outerRadius: 1.58, innerEndRadius: 0.66, outerStartRadius: 1.48, outerEndRadius: 1.72, startAngleDeg: -36, endAngleDeg: 20 },
    { id: "kuat", name: "Kuat Sector", regionId: "core", grid: "M-9", factionId: "jedi-republic", placementConfidence: "Core Worlds broad placement", innerRadius: 0.72, outerRadius: 1.52, innerStartRadius: 0.62, outerEndRadius: 1.68, startAngleDeg: 20, endAngleDeg: 82 },
    { id: "alderaan", name: "Alderaan Sector", regionId: "core", grid: "M-10", factionId: "jedi-republic", placementConfidence: "Core Worlds broad placement", innerRadius: 0.7, outerRadius: 1.46, outerStartRadius: 1.62, outerEndRadius: 1.34, startAngleDeg: 82, endAngleDeg: 148 },
    { id: "alsakan", name: "Alsakan Sector", regionId: "core", grid: "L-10", factionId: "jedi-republic", placementConfidence: "Core Worlds broad placement", innerRadius: 0.58, outerRadius: 1.38, innerStartRadius: 0.48, outerEndRadius: 1.52, startAngleDeg: 148, endAngleDeg: 210 },
    { id: "brentaal", name: "Brentaal Sector", regionId: "colonies", grid: "L-9", factionId: "jedi-republic", placementConfidence: "Colonies / major route broad placement", innerRadius: 1.34, outerRadius: 2.24, outerStartRadius: 2.05, outerEndRadius: 2.42, startAngleDeg: -160, endAngleDeg: -106 },
    { id: "duro", name: "Duro Sector", regionId: "colonies", grid: "M-10", factionId: "jedi-republic", placementConfidence: "Colonies broad placement", innerRadius: 1.36, outerRadius: 2.18, innerEndRadius: 1.22, outerStartRadius: 2.34, startAngleDeg: -106, endAngleDeg: -56 },
    { id: "tapani", name: "Tapani Sector", regionId: "colonies", grid: "M-11", factionId: "jedi-republic", placementConfidence: "Colonies/Inner Rim broad placement", innerRadius: 1.5, outerRadius: 2.4, outerStartRadius: 2.18, outerEndRadius: 2.58, startAngleDeg: -56, endAngleDeg: 4 },
    ...
    { id: "balmorra", name: "Balmorra Sector", regionId: "expansion", grid: "M-10", factionId: "sith-empire", placementConfidence: "Old Republic campaign-world broad placement", innerRadius: 2.66, outerRadius: 3.86, outerStartRadius: 3.62, outerEndRadius: 4.02, startAngleDeg: -172, endAngleDeg: -128 },
    { id: "taris", name: "Taris Sector", regionId: "outer-rim", grid: "M-10", factionId: "jedi-republic", placementConfidence: "Old Republic campaign-world broad placement", innerRadius: 2.84, outerRadius: 4.22, outerStartRadius: 4.34, outerEndRadius: 4.06, startAngleDeg: -128, endAngleDeg: -88 },
    ...
    { id: "belsavis", name: "Belsavis Sector", regionId: "outer-rim", grid: "Q-16", factionId: "jedi-republic", placementConfidence: "Old Republic campaign-world broad placement", innerRadius: 3.94, outerRadius: 5.36, outerStartRadius: 5.5, outerEndRadius: 5.1, startAngleDeg: 136, endAngleDeg: 178 },
    ...
    { id: "dromund", name: "Dromund Sector", regionId: "outer-rim", grid: "S-5", factionId: "sith-empire", placementConfidence: "Sith Empire / Dromund Kaas broad placement", innerRadius: 4.96, outerRadius: 6.4, outerStartRadius: 6.22, outerEndRadius: 6.58, startAngleDeg: -32, endAngleDeg: -4 },
