...
export const metadata = holonetMetadata({
  ...
  description: "A cinematic reading of The Mandate."
});
  ...
  return (
    ...
    >
      ...
      <div className="v2-scroll-container">
        ...
        <section className="v2-page v2-proclamation">
        ...
        <section className="v2-page v2-record">
          <div className="v2-header-bar">
            <div className="v2-header-accent"></div>
            <h3>RECORD</h3>
          </div>
          <div className="v2-induction">INDUCTION // <span className="white-text">March 2020</span></div>
          ...
          <div className="v2-record-section">
            ...
            <div className="v2-positions-grid">
              ...
              <div className="pos-item border-right">
                <h5>THE REAVERS</h5>
                <p>MAR - MAY 22</p>
                <p>SEP - NOV 23</p>
                <p>MAY 25 - PRES.</p>
        ...
        <section className="v2-page v2-ultimatum">
          <div className="v2-header-bar">
            <div className="v2-header-accent"></div>
            <h3>ULTIMATUM</h3>
          </div>
          <div className="v2-text-content">
            ...
            <p className="v2-italic">Only the strong shall inherit the stars.</p>
            <div className="v2-signature">Vyberon</div>
          </div>
        </section>
      </div>
